...
insert into TypeSignalement(NomType, Couleur) values ('Deterioration bien publique','blue'),('routes abimées','orange'),('Environment','green');
...
insert into StatusSignalement(NomStatus) values ('Envoye'),('En Cours'),('Terminé');
...
VALUES
  (6,"Blossom","Mosley","dapibus.rutrum.justo@yahoo.org","GJT62HEM4UU"),
