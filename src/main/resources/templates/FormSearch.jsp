        ...
        <div class="container-scroller">
            ...
            <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                    ...
                    <div>
                        <a class="navbar-brand brand-logo" href="http://localhost:8081/backoffice/">
                            <img src="images/logo.svg" alt="logo" />
                        </a>
                        <a class="navbar-brand brand-logo-mini" href="http://localhost:8081/backoffice/">
                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <sf:form method="POST" modelAttribute="Statistique" action="http://localhost:8081/backoffice/find">
                                            <form class="forms-sample">
                                                ...
                                                <button class="btn btn-light" onclick="window.location.href = 'http://localhost:8081/backoffice/FormSearch'">Cancel</button>
                                            </form>
                                        </sf:form>
                                    </div>
                                </div>
